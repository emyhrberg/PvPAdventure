...
//        .Add(new Item(ItemID.Blowpipe) { shopCustomPrice = Item.buyPrice(silver: 155) })
//        .Add(new Item(ItemID.Seed) { shopCustomPrice = Item.buyPrice(silver: 2) })
//        .Add(new Item(ItemID.BlandWhip) { shopCustomPrice = Item.buyPrice(silver: 375) })
...
//        .Add(new Item(ItemID.IronskinPotion) { shopCustomPrice = Item.buyPrice(silver: 225) })
//        .Add(new Item(ItemID.ThrowingKnife) { shopCustomPrice = Item.buyPrice(silver: 9) })
//        .Add(new Item(ItemID.Shuriken) { shopCustomPrice = Item.buyPrice(silver: 7) })
...
//        .Add(new Item(ItemID.Trident) { shopCustomPrice = Item.buyPrice(silver: 250) })
...
//        .Add(new Item(ItemID.WandofSparking) { shopCustomPrice = Item.buyPrice(silver: 675) })
...
//        .Add(new Item(ItemID.GoldWorm) { shopCustomPrice = Item.buyPrice(silver: 700) })
...
//        .Add(new Item(ItemID.DPSMeter) { shopCustomPrice = Item.buyPrice(copper: 1) })
