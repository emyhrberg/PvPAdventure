...
/// <summary>
/// The StickyPowerBomb projectile from vanilla 1.4.5, recreated.
/// </summary>
internal class StickyPowerBombProjectile : ModProjectile
{
    public override string Texture => "PvPAdventure/Assets/Projectiles/StickyPowerBombProjectile";
    ...
    {
        if (_stuck) //sticky bomb behavior
        {
            if (!IsTouchingTile())
            {
                _stuck = false;
    ...
    {
        int left = (int)(Projectile.Left.X / 16f) - 1;
        int right = (int)(Projectile.Right.X / 16f) + 1;
        int top = (int)(Projectile.Top.Y / 16f) - 1;
        int bottom = (int)(Projectile.Bottom.Y / 16f) + 1;
